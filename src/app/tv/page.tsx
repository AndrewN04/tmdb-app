    ...
    <div className="container py-8 px-4 sm:px-8 max-w-7xl mx-auto">
      ...
      <div className="mb-10 space-y-2">
        <div className="flex items-center gap-3">
          ...
          <h1 className="text-3xl font-bold tracking-tight">Explore TV Shows</h1>
        </div>
        <p className="text-muted-foreground pl-[52px]">
          Discover {data.total_results.toLocaleString()} TV shows to binge
        </p>
      </div>
      ...
      <div className="flex flex-col lg:flex-row gap-8">
        ...
        <div className="w-full lg:w-72 shrink-0">
          <FilterSidebar genres={genres} type="tv" />
        </div>
          ...
          <div className="flex items-center justify-center gap-2">
            {page > 1 && (
              <Button 
                ...
                asChild
              >
                <Link href={`/tv?page=${page - 1}&sort_by=${sortBy}${withGenres ? `&with_genres=${withGenres}` : ''}`}>
